...
+ DC系数 
<img src="https://github.com/cucrui/Data-compression/blob/master/%E5%AE%9E%E9%AA%8C5_JPEG%E8%A7%A3%E7%A0%81/img/DC_yuv.png" width=256 />

+ AC系数 
<img src="https://github.com/cucrui/Data-compression/blob/master/%E5%AE%9E%E9%AA%8C5_JPEG%E8%A7%A3%E7%A0%81/img/AC_yuv.png" width=256 /> 

+ 原图Y分量概率分布
<img src="https://github.com/cucrui/Data-compression/blob/master/%E5%AE%9E%E9%AA%8C5_JPEG%E8%A7%A3%E7%A0%81/img/原图.png" width=512 />

+ DC系数概率分布 
<img src="https://github.com/cucrui/Data-compression/blob/master/%E5%AE%9E%E9%AA%8C5_JPEG%E8%A7%A3%E7%A0%81/img/DC系数.png" width=512 />

+ AC系数概率分布 
<img src="https://github.com/cucrui/Data-compression/blob/master/%E5%AE%9E%E9%AA%8C5_JPEG%E8%A7%A3%E7%A0%81/img/AC系数.png" width=512 />

## 五.实验结论

为了显示灰度图，u,v分量均设为128，所以在概率分布图中128会出现很多次，这里我们可以忽略。

从可视化DC系数可以看出，DC系数表征的就是图像结构，和原图像的灰度图没有太大区别，而概率分布也较为均匀。AC系数中我们可以看到有一个明显的尖峰，联系二维DCT变换原理可知，该系数表征的是图像的水平和垂直方向上某一个变化的频率，如果是其他位置的AC系数，尖峰就会出现在其他数值的地方。结合可视化AC图像可以看出，边缘的地方接近白色，也就是频率高的地方被显示出来。
